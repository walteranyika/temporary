           ...
           <div class="panel-heading">All Contributions</div>
            ...
            <table class="table table-bordered">
                    <thead>
                      ...
                      <?php
                         include 'connect.php';
                         $sql="SELECT  contributions.contribution_id, members.names,contributions.date_contributed, contributions.contribution_amt FROM    members INNER JOIN contributions ON members.meber_id=contributions.member_id";
