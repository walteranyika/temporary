...
<body style="background-color:#00838f">
 ...
 <div class="container_middle">		
      ...
      <div class="panel-heading"><h1><span class="glyphicon glyphicon-user"></span> New Member Registration</h1></div>
                                ...
                                <form role="form" action="_add_member.php" method="POST">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <select class="form-control" name="company" >
                                                <option value="1">G4S</option>
                                                <option value="2">United Securities</option>
                                                <option value="3">Paul Securities</option>
                                                <!--Fetch From DB-->
                                            </select>
                                    </div>
